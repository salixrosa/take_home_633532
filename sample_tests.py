...
def test_cases_using_sample_data():
    ...
    for test_case in test_cases_on_sample_routes:
        calculated_path, calculated_distance = shortest_path(sample_graph, Node(test_case[0]),
                                                             Node(test_case[1]))
...
def test_duplicate_edges():  # known to be failing
    ...
    calculated_path, calculated_distance = shortest_path(bad_graph, node_a, node_b)
...
def test_cyclic_routes():
    ...
    calculated_path, calculated_distance = shortest_path(cyclic_simple_graph, node_a, node_d)
...
def test_nonsensical_edge():
    ...
    calculated_path, calculated_distance = shortest_path(simple_graph_with_nonsensical_edge, node_a, node_b)
...
def test_zero_cost_edge():
    ...
    calculated_path, calculated_distance = shortest_path(simple_graph_with_free_edge, node_a, node_c)
...
def test_paths_of_equal_distance_both_returned():
    ...
    calculated_paths, calculated_distance = shortest_path(graph, node_a, node_d)
...
def test_paths_of_equal_distance_different_node_counts_both_returned():
    ...
    calculated_path, calculated_distance = shortest_path(graph, node_a, node_c)
